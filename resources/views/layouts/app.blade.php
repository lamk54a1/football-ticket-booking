...
<body>
    ...
    <footer class="bg-dark text-light py-4 mt-4">
        <div class="container text-center">
            <p class="mb-0">&copy; {{ date('Y') }} Hệ thống đặt vé. All rights reserved.</p>
            <p class="mb-0">Liên hệ: <a href="mailto:support@example.com" class="text-light">support@example.com</a></p>
        </div>
    </footer>
